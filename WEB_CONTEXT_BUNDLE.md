...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1105-questions-in-geometric-group-theory-q-a92cfc89",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1105-cdfaff4415dd",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1105"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Bridson) Classify the mapping tori of automorphisms $\\mathbb{Z}^n\\to\\mathbb{Z}^n$ up to quasi-isometry.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 11.5",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "54738e5ba92efe11a762cab9ca2e73ac03cc1b1d1ed79736e69a290c5923d8c2"
}
```
